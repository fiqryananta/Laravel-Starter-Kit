    ...
    <body class="boxed-size bg-white">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-12">
                            <div class="mw-480 ms-lg-auto">
                                ...
                                <h3 class="fs-28 mb-2">Lupa Kata Sandi?</h3>
                                <p class="fw-medium fs-16 mb-4">Masukkan Email Anda Untuk Mendapat Tautan Mengganti Kata Sandi</p>
                                <form id="form">
                                    ...
                                    <div class="form-group">
                                        <p>Kembali Ke Halaman <a href="{{ route('authentication.login') }}" class="fw-medium text-primary text-decoration-none">Login</a></p>
                                    </div>
                                </form>
                            </div>
                        </div>
        ...
        $(document).ready(function () {
            $('#form').on('submit', function (e) {
                ...
                $.ajax({
                    url: "{{ route('authentication.forgot_password') }}",
                    method: "POST",
                    data: $(this).serialize(),
                    headers: {

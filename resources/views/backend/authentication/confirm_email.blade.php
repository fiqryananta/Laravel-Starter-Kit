                    ...
                    <form style="max-width: 550px;">
                        <div class="card bg-white border-0 rounded-10 mb-4 text-center">
                            <div class="card-body p-4">
                                ...
                                <img src="{{ mix('backend/images/message.svg') }}" class="mb-3 mb-md-4" alt="message">
                                <h4 class="fs-20 fw-semibold mb-2">Konfirmasi Email Anda</h4>
                                <p class="mb-4">Pendaftaran Berhasil Dilakukan, Email Konfirmasi Telah Dikirim Ke Alamat Email Anda. Silahkan Periksa Email Masuk Dari Kami Untuk Melakukan Konfirmasi.</p>
                                <p class="mb-4">Jika Tidak Menerima Tautan Konfirmasi Email, Silahkan Klik Untuk Mengirim Ulang.</p>
                                ...
                                <div class="form-group mt-10">
                                    <p>Atau, Kembali Ke <a href="{{ route('authentication.login') }}" class="fw-medium text-primary text-decoration-none">Halaman Login</a></p>
                                </div>
                            </div>
                        </div>
                    </form>

    ...
    <body class="boxed-size bg-white">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-12">
                            <div class="mw-480 ms-lg-auto">
                                ...
                                <h3 class="fs-28 mb-2">Masukkan Kata Sandi Baru</h3>
                                <p class="fw-medium fs-16 mb-4">Silahkan Masukkan Kata Sandi Baru Untuk Mengganti Kata Sandi Sebelumnya</p>
                                <form id="form">
                                    <div class="form-group mb-4">
                                        <label class="label text-secondary">Kata Sandi Baru</label>
                    ...
                    <form style="max-width: 550px;">
                        <div class="card bg-white border-0 rounded-10 mb-4 text-center">
                            <div class="card-body p-4">
                                ...
                                <img src="{{ mix('backend/images/error.png') }}" style="height: 100px;" class="mb-3 mb-md-4" alt="message">
                                <h4 class="fs-20 fw-semibold mb-2">Tuatan Sudah Tidak Berlaku</h4>
                                <p class="mb-4">Silahkan Kirim Ulang Tautan Untuk Mengganti Kata Sandi</p>

                                <a href="{{ route('authentication.forgot_password') }}" class="btn btn-primary fs-16 fw-medium text-dark py-2 px-4 text-white w-100">
                                    Kirim Ulang
                                </a>
        ...
        $(document).ready(function () {
            $('#form').on('submit', function (e) {
                ...
                $.ajax({
                    url: "{{ route('authentication.change_password', $token) }}",
                    method: "POST",
                    data: $(this).serialize(),
                    headers: {
                    ...
                    success: function (response) {
                        ...
                        if (response.success) {
                            ...
                            Swal.fire({
                                icon: "error",
                                title: 'Kata Sandi Gagal Diganti',

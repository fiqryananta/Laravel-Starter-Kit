    ...
    <body class="boxed-size bg-white">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-12">
                            <div class="mw-480 ms-lg-auto">
                                ...
                                <h3 class="fs-28 mb-2">Daftar Akun {{ env('APP_NAME') }}</h3>
                                <p class="fw-medium fs-16 mb-4">Silahkan Lengkapi Data Untuk Melakukan Pendaftaran</p>
                                <form id="form">
                                    <div class="form-group mb-4">
                                        <label class="label text-secondary">Nama Perusahaan</label>
                                        <input type="text" class="form-control h-55" placeholder="Masukkan Nama Perusahaan" name="company_name">
                                    </div>
                                    <div class="form-group mb-4">
                                    ...
                                    <div class="form-group mb-4">
                                        <button class="btn btn-primary fw-medium py-2 px-3 w-100" id="submit-btn">
                                            <div class="d-flex align-items-center justify-content-center py-1">
                                                ...
                                                <i id="icon-submit" class="material-symbols-outlined text-white fs-20 me-2">person_4</i>
                                                <span id="btn-text">Daftar</span>
                                            </div>
                                        </button>
                                    </div>
                                    <div class="form-group">
                                        <p>Dengan Mendaftarkan Akun Anda, Anda Telah Setuju Dengan <a href="{{ route('authentication.terms_of_service') }}"class="fw-medium text-decoration-none">Terms of Service</a> , Telah Membaca dan Menyetujui <a href="{{ route('authentication.privacy_policy') }}"class="fw-medium text-decoration-none">Privacy Policy</a>.</p>
                                    </div>
                                </form>
                            </div>
                        </div>
        ...
        $(document).ready(function () {
            $('#form').on('submit', function (e) {
                ...
                $.ajax({
                    url: "{{ route('authentication.registration') }}",
                    method: "POST",
                    data: $(this).serialize(),
                    headers: {

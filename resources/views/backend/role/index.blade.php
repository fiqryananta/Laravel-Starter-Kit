    ...
    <script>
        ...
        $('#table').DataTable({
            ...
            columns: [
                ...
                { data: 'name', name: 'name' },
                { data: 'count_user', name: 'count_user', orderable: false, searchable: false },
        ...
        <div class="card bg-white border-0 rounded-3 mb-4">
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
                    ...
                    <a href="{{ route('role.add') }}" class="btn btn-primary fw-medium text-white py-2 px-4"><i class="ri-add-line"></i> Tambah</a>
                </div>
